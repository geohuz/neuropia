...
const OLLAMA = "ollama";
const GOOGLE_VERTEX_AI = "vertex-ai";
const TRITON = "triton";
const AZURE_OPEN_AI = "azure-openai";

// 内联验证函数
const isValidCustomHost = (host) => {
  return host && host.indexOf("api.portkey") === -1;
};

// 完整的 schema 定义
const portkeyConfigSchema = z
  .object({
    strategy: z
      .object({
        mode: z
    ...
    on_status_codes: z.array(z.number()).optional(),
    targets: z.array(z.lazy(() => portkeyConfigSchema)).optional(),
...
module.exports = { portkeyConfigSchema };
